...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/_app': RouteRecordInfo<'/_app', '/app', Record<never, never>, Record<never, never>>,
    ...
    '/_demo': RouteRecordInfo<'/_demo', '/demo', Record<never, never>, Record<never, never>>,
    '/_login': RouteRecordInfo<'/_login', '/login', Record<never, never>, Record<never, never>>,
  }
}
